                ...
                <div class="card-body">
                    ...
                    <div class="container-fluid m-0 p-0">
                        ...
                        <div class="col-md-4 p-2">
                            ...
                            <input id="department" placeholder="Department" class="form-control" type="text"/>
                        </div>
                    </div>
                        <div class="row m-0 p-0">
                            <div class="col-md-4 p-2">
   ...
   async function onRegistration() { 
       ...
       // let passwordRegex = /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/;
        ...
        //  }
          ...
          showLoader();
          let res = await axios.post("/restration-employee",{
       ...
       if(res.data===1){
         successToast("Employee Registered Success")
         setTimeout(function()  {
