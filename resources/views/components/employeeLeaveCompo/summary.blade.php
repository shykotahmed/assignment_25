                            ...
                            <div class="p-3">
                                <div class="row">
                                    <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                                        <div>
                                            <h3 id="total-application" class="mb-0 text-capitalize font-weight-bold">00</h3>
                                            <p class="mb-0 text-lg">Total Leave application</p>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                                        <div>
                                            ...
                                            <p class="mb-0 text-lg">Total Apperoved</p>
                                        </div>
                                    </div>
                                    <div class="col-3 col-lg-4 col-md-4 col-sm-3 text-end">
                                        <div class="icon icon-shape bg-gradient-primary shadow float-end border-radius-md">
                            ...
                            <div class="row">
                                <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                                    <div>
                                        ...
                                        <p class="mb-0 text-lg">Pending</p>
                                    </div>
                                </div>
                                <div class="col- col-lg-4 col-md-4 col-sm-3 text-end">
                                    <div class="icon icon-shape bg-gradient-primary shadow float-end border-radius-md">
...
<script>
  ...
  //  TotalCustomer();
    ...
    function  TotalLeaveCalculation() {
        fetchDataAndUpdate("total-application", "/total-leaveApplication");
    }

    function TotalPending() {
        fetchDataAndUpdate("total-pending", "/total-pending-by-emp");
    }
